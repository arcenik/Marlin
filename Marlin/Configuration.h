...
#define STRING_CONFIG_H_AUTHOR "(François Scala, Ender 5 Plus)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 137.21 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -8, -2.8 }
